...
ENTER_STOCKS_AGAIN:
    ...
    gotopositionxy(43, 28 + sn);
    printf("%s", temp_company_name);
    gotopositionxy(63, 28 + sn);
    printf("%d", qt);
    gotopositionxy(70, 28 + sn);
    printf("%d", temp_price);
    gotopositionxy(79, 28 + sn);
...
void display_bill_customer()
{
    ...
    gotopositionxy(103, 22);
    printf(" customer bill is printed on  ");
    gotopositionxy(105, 23);
    // printf("\"%s\" file", fname);
    printf(" bills.txt ");
    gotopositionxy(98, 25);
    printf("       CUSTOMER'S BILL\n");
    gotopositionxy(100, 26);
    printf("	  NAVY CYBER STORE           \n");
    gotopositionxy(103, 27);
    printf("	      L.A., USA               \n");
    gotopositionxy(105, 28);
    printf("                     - 12 June        \n"); // fprintf("\t\t\t\t\t%s", ctime(&t)); // Print Time
    gotopositionxy(93, 29);
    printf("------------------------------------------\n");
    printf("\n");
    gotopositionxy(94, 30);
    printf("Particulars	Rate	Qty.	Amount\n");
    gotopositionxy(93, 31);
    printf("------------------------------------------\n");
}
...
void separator_line()
{
    ...
    printf("\n");
    gotopositionxy(90, 22);
    printf("||");
    gotopositionxy(90, 23);
    printf("||");
    gotopositionxy(90, 24);
    printf("||");
    gotopositionxy(90, 25);
    printf("||");
    gotopositionxy(90, 26);
    printf("||");
    gotopositionxy(90, 27);
    printf("||");
    gotopositionxy(90, 28);
    printf("||");
    gotopositionxy(90, 29);
    printf("||");
    gotopositionxy(90, 30);
    printf("||");
    gotopositionxy(90, 31);
    printf("||");
    gotopositionxy(90, 32);
    printf("||");
    gotopositionxy(90, 33);
    printf("||");
    gotopositionxy(90, 34);
    printf("||");
    gotopositionxy(90, 35);
    printf("||");
    gotopositionxy(90, 36);
    printf("||");
    gotopositionxy(90, 37);
    printf("||");
    gotopositionxy(90, 38);
    printf("||");
    gotopositionxy(90, 39);
    printf("||");
    gotopositionxy(90, 40);
    printf("||");
    gotopositionxy(90, 41);
    printf("||");
    gotopositionxy(90, 42);
    printf("||");
    gotopositionxy(90, 43);
    printf("||");
    gotopositionxy(90, 44);
    printf("||");
    gotopositionxy(90, 45);
    printf("||");
    gotopositionxy(90, 46);
    printf("||");
    gotopositionxy(90, 47);
    printf("||");
    gotopositionxy(90, 48);
    printf("||");
    gotopositionxy(90, 49);
    printf("||");
}
