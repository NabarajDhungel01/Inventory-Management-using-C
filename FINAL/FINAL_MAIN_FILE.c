...
ENTER_STOCKS_AGAIN:
    ...
    gotopositionxy(47, 28 + sn + 2); // will print after all the products are shown on the bill
    printf("======================");

    gotopositionxy(48, 28 + sn + 3);
    printf("Grand Total:   %d", Grand_Total_Price);

    gotopositionxy(47, 28 + sn + 4);
    printf("======================");
